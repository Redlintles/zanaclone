      ...
      <StyledLocalizationMain>
        <div>
          ...
          <section className="localization-main__text">
            <ItemText fontSize="1.5rem">Zanaflex &reg;</ItemText>
            <ItemText>Zanaflex Borrachas Ltda.</ItemText>
            <ItemText>Av. Vasco Massafeli, 1010</ItemText>
            <ItemText>Cotia - SP - Brasil - CEP 06703-600</ItemText>
            <ItemText>Fone : +55 (11) 2165-3450</ItemText>
            <ItemText>Fax : +55 (11) 2165-3451</ItemText>
